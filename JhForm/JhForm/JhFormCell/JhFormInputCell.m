...
- (void)layoutSubviews {
    ...
    if (!_data.Jh_title.length) {
        ...
        CGFloat newHeight = [JhFormInputCell heightWithCellModelData:self.data];
        if(_data.Jh_rightViewWidth>0){
            self.rightTextView.frame = CGRectMake(self.data.Jh_titleWidth + 2*Jh_Margin_Right, Jh_Margin_Right+2, Jh_SCRREN_WIDTH - (self.data.Jh_titleWidth + 3*Jh_Margin_Right)-_data.Jh_rightViewWidth, newHeight - 2*Jh_Margin_Right);
            self.rightView.frame =CGRectMake(CGRectGetMaxX(self.rightTextView.frame), 0, _data.Jh_rightViewWidth, self.bounds.size.height);
        }else{
            self.rightTextView.frame = CGRectMake(self.data.Jh_titleWidth + 2*Jh_Margin_Right, Jh_Margin_Right+2, Jh_SCRREN_WIDTH - (self.data.Jh_titleWidth + 3*Jh_Margin_Right), newHeight - 2*Jh_Margin_Right);
        }
...
+ (CGFloat)heightWithCellModelData:(JhFormCellModel *)data{
    ...
    if (!data.Jh_title.length) {
        ...
        width = (data.Jh_rightViewWidth>0) ? (data.Jh_titleWidth + 3*Jh_Margin_Right+data.Jh_rightViewWidth) : (data.Jh_titleWidth + 3*Jh_Margin_Right);
    }
